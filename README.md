...
![](https://img.shields.io/badge/Number-255-blue)
...
* 解空间明确且可遍历
* 序列有序
  这里的有序是一个比较宽泛的概念，不要求严格有序，而是有一定的有序的特点，可以找到二分的切入点
* 求最大最小值
...
完整实现：[普通UF](./src/main/java/GraphTopic/UF/UF.java)
...
完整实现：[QuickUF](./src/main/java/GraphTopic/UF/QuickUF.java)
...
完整路径压缩版本的UF：[PathCompressedUF](./src/main/java/GraphTopic/UF/PathCompressedUF.java)
